...
import { usePathname, useRouter, localeNames } from '@/app/_lib/routing';
import { LOCALES, Locale } from '@/core/domain/Locale';
...
function selectLocaleFactory(
  router: { replace: (path: string, opts?: { locale?: Locale }) => void | Promise<void> },
  pathname: string,
  onClose: () => void
) {
